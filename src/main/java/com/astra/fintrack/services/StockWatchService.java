...
import com.astra.fintrack.repos.StockPriceEntryRepository;
...
public class StockWatchService {
    ...
    public StockWatchService(StockPriceEntryRepository priceRepo, StockWatchRepository stockWatchRepository) {
    ...
    private Optional<Double> fetchCurrentPrice(String symbol) {
        ...
        try {
            ...
            if (response.statusCode() == 200) {
                ...
                System.err.println("Failed to fetch data for symbol: " + symbol + " (HTTP " + response.statusCode() + ")");
            }
